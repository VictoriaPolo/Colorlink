...
/** Orden de avance del ciclo de vida de una solicitud. Fuente única de verdad
 * para la máquina de estados (ver domain/solicitud/estadoMachine.ts). */
export const ORDEN_ESTADOS: EstadoSolicitud[] = [
  'Recibida',
  'En análisis',
  'Solución propuesta',
  'En abastecimiento',
